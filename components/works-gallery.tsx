...
const projects = [
  ...
  },
  {
    ...
    year: "2026",
    description: "AI Exoplanet Detector using a CNN-MLP hybrid architecture scanning 5,087 stars. Optimized for 100% recall over simple accuracy. Integrates SHAP for transit-dip attention heatmaps and SMOTE for handling severely imbalanced stellar flux data.",
    ...
    spriteName: "epicDrop",
    tech: ["TensorFlow", "CNN-MLP", "SHAP", "SMOTE", "Python"],
    metrics: [
      { label: "RECALL", value: "100%" },
      { label: "STARS", value: "5,087" },
      { label: "ARCH", value: "CNN+MLP" },
    ],
    highlight: "100% Recall — No Planet Missed",
  },
  {
    id: 3,
    title: "MANAS MITRA",
